    ...
    <div className="min-h-screen bg-[#F5F2EB] animate-fade-in-up">
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-12 -mt-32 relative z-10 pb-32">
        <div className="bg-[#F5F2EB] p-8 md:p-16 shadow-xl shadow-[#2C2A26]/5">
          ...
          <h1 className="text-4xl md:text-6xl font-serif text-[#2C2A26] mb-2 leading-tight text-center">
            {article.title}
          </h1>
          <h2 className="text-2xl md:text-3xl font-light text-[#5D5A53] mb-12 text-center">
            {article.titleZh}
          </h2>
          ...
          <div className="mt-16 pt-12 border-t border-[#D6D1C7] flex justify-center">
            <span className="text-2xl font-serif italic text-[#2C2A26]">LINEA</span>
          </div>
        </div>
      </div>
    </div>
